...
namespace ObsidianLauncher.Models
{
    ...
    {
        public string PlainStringValue { get; private set; }
        public ConditionalArgumentValue ConditionalValue { get; private set; }
        ...
        public static VersionArgument Create(string plainValue) => new VersionArgument(plainValue);
        public static VersionArgument Create(ConditionalArgumentValue conditionalValue) => new VersionArgument(conditionalValue);
    }
    ...
    public class VersionArgumentConverter : JsonConverter<VersionArgument>
    {
        public override VersionArgument Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            {
                return VersionArgument.Create(reader.GetString());
            }
