...
public class VersionMetadata
{
    ...
    [JsonPropertyName("url")] public string Url { get; set; } // URL to the version-specific JSON
    ...
    [JsonPropertyName("sha1")] public string Sha1 { get; set; } // SHA1 of the version-specific JSON file
