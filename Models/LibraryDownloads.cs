...
namespace ObsidianLauncher.Models
{
    ...
    public class LibraryDownloads
    {
        ...
        /// <summary>
        /// A dictionary of classified artifacts. The key is the classifier name (e.g., "natives-windows", "natives-linux", "sources", "javadoc").
        /// The value provides the download details for that classified artifact. Can be null or empty.
        /// </summary>
        [JsonPropertyName("classifiers")]
        public Dictionary<string, LibraryArtifact> Classifiers { get; set; } // Nullable if "classifiers" object might be absent
